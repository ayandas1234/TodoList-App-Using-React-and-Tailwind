...
function App() {
  // todo Add into todo list
  const [todo, setTodo] = useState("")

  // todos hold all the todos in a Array
    ...
    <>
      ...
      <div className="mx-3 md:container md:mx-auto  my-5 rounded-xl p-5 bg-violet-100 min-h-[88vh] md:w-1/2">
        ...
        <div className="addTodo my-5 flex flex-col gap-4">
          ...
          <div className="flex">
            <input placeholder='Type Your Message' onChange={handleChange} value={todo} type="text" className='w-full rounded-full px-5 py-1' />
            <button onClick={handleAdd} disabled={todo.length <= 3} className='bg-violet-800 hover:bg-violet-950 disabled:bg-violet-400 p-4 py-2 text-sm font-bold text-white rounded-full mx-2'>Save</button>
          </div>
        </div>
